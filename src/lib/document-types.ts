...
export const DOCUMENT_TYPES: Array<{ id: DocumentTypeId; label: string; description: string; instruction: string }> = [
  ...
  { id: 'novel', label: '小說／文學', description: '重視敘事聲音、人物語氣與對話節奏', instruction: '保留敘事視角、角色語氣與修辭效果；人物對話各自成段。沿用正典中的人物、地名與組織譯名。提取新角色／實體時使用「原名: 固定譯名（原文明示的關係／設定）」格式；摘要記錄當段視角、明示的時間線索與事件，區分回憶和現在，不推測未知關係，不因後文資訊改寫前文伏筆。' },
